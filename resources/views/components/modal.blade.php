...
<div 
    x-data="{ show: false, name: @js($name) }" x-show="show" @open-modal.window="if($event.detail === name) show = true"
    ...
    x-transition:leave-end="opacity-0 -translate-y-4 -translate-x-4" role="dialog" aria-modal="true"
